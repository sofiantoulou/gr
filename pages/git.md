...
Το βιβλίο είναι αποθηκευμένο στο σύστημα του [github](http://www.github.com). Ο καλύτερος τρόπος για να βελτιώσετε το βιβλίο είναι να κάνετε fork, να κάνετε τις αλλαγές που θέλετε, και να κάνετε ένα [pull request](https://guides.github.com/activities/hello-world/#pr).
