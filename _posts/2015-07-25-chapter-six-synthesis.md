...
layout: page
title:  "Κεφάλαιο Εξι"
subheadline:  "Σύνθεση και Κλίμακα"
teaser: "Το έκτο κεφάλαιο περιγράφει των προγραμματισμού της διάδρασης για συστήματα που είναι σύνθετα και έχουν μεγάλη κλίμακα."
categories:
    - chapters
tags:
    - book
